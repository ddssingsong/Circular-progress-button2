...
public class CircularProgressButton extends Button {
    ...
    private StateManager mStateManager;//状态管理类
    private State mState;//状态
    private String mIdleText;//Idle状态下的文字
    private String mCompleteText;//完成时的文字
    private String mErrorText;//出错时的文字
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int blue = getColor(R.color.cpb_blue);//进度条
            int white = getColor(R.color.cpb_white);//内部
            int grey = getColor(R.color.cpb_grey);//进度条空的部分
